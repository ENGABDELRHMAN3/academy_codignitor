            ...
            <div class="accordion-body position-relative">
              ...
              <ul class="course-content-items" style="<?php if($is_restricted) echo 'filter: blur(1px);' ?>">
                ...
                foreach($lessons as $lessonkey => $lesson):
                  $studentCountView = $this->crud_model->get_student_lesson_watch_count($lesson['id'], $course_id);
                  ...
                  <li class="item <?php if($lesson['id'] == $lesson_details['id']) echo 'active'; ?>">
                    <a href="<?php if(($studentCountView <= $lesson['view_count']-1)|| $lesson['lesson_type'] == 'quiz'){echo  $lesson_url; }else{echo '#';}?>" class="d-flex align-items-baseline w-100 checkbox-box-a">
                      ...
                      <?php
                      if($studentCountView >= $lesson['view_count'] && $lesson['lesson_type'] != 'quiz' ):
                        // if($sectionkey!=0 && $lessonkey!=0){?>
                                                <span class="ms-auto text text-danger"><?php echo get_phrase('You\'ve exceeded the view limit') ?></span>
