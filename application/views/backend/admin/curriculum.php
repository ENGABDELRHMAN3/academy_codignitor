...
<div class="row justify-content-center">
    <div class="col-xl-12 mb-4 text-center mt-3">
        ...
        <?php if (count($sections) > 0): ?>
            ...
            <a href="javascript:void(0)" class="btn btn-outline-primary btn-rounded btn-sm ml-1" onclick="showAjaxModal('<?php echo site_url('modal/popup/add_revison/'.$course_id); ?>', '<?php echo get_phrase('add_revison'); ?>')"><i class="mdi mdi-twitter-retweet"></i> <?php echo get_phrase('add_revison'); ?></a>
                            ...
                            <div class="card text-secondary on-hover-action mb-2 w-100" id = "<?php echo 'lesson-'.$lesson['id']; ?>">
                                <div class="card-body thinner-card-body">
                                    ...
                                    <h5 class="card-title mb-0">
                                        ...
                                        View Count:<?php echo $lesson['view_count']; ?>
                                        </span>
                                    </h5>
                                </div>
                            </div> <!-- end card-->
